...
public class Static {
    ...
    public static Film compareFilms(Film a, Film b) { //method for comparing films by rating and awards
        ratingA = a.getRating();
        ratingB = b.getRating();
    ...
    public static Series compareSeries(Series a, Series b) { //method for comparing series by rating and seasons
        ratingA = a.getRating();
        ratingB = b.getRating();
